...
const BLOG = {
  ...
  KEYWORDS:
    ...
    'Wjhtkj, Endless, 博客, 折腾, 技术, 生活, Notion', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar.png', // 站点头像，默认使用 /public/avatar.png；Notion 配置表中设置 AVATAR 可覆盖
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到我的小站, Hi，这里记录折腾与分享,Hi，随便逛逛吧,欢迎来到我的博客🎉',
